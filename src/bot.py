...
class Bot:
    def __init__(self, screen: Screen, game_stats: GameStats, template_finder: TemplateFinder, pick_corpse: bool = False):
        ...
        self._trav = Trav(self._template_finder, self._pather, self._town_manager, self._ui_manager, self._char, self._pickit, self._screen)
        ...
        self._transitions = [
            ...
            # End run / game
            { 'trigger': 'end_run', 'source': ['shenk', 'pindle', 'nihlatak', 'trav', 'arcane', 'diablo', 'meph', 'baal'], 'dest': 'town', 'before': "on_end_run"},
            { 'trigger': 'end_run', 'source': ['shenk', 'pindle', 'nihlatak', 'trav', 'arcane', 'diablo', 'meph', 'baal'], 'dest': 'town', 'before': "on_end_run"},
            { 'trigger': 'end_game', 'source': ['town', 'shenk', 'pindle', 'nihlatak', 'trav', 'arcane', 'diablo', 'meph', 'baal', 'end_run'], 'dest': 'hero_selection', 'before': "on_end_game"},
        ]
    ...
    def on_run_meph(self):
        ...
        self._game_stats.update_location("Meph" if self._config.general['discord_status_condensed'] else "Meph")
    ...
    def on_run_baal(self):
        ...
        self._game_stats.update_location("Baal" if self._config.general['discord_status_condensed'] else "Meph")
